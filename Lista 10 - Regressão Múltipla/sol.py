...
Original file is located at
    https://colab.research.google.com/drive/1iEs-WwQliRCzRRqwdhbY_LTtqv-r6Zxb
...
X["mpg"]  = X["mpg"].transform(lambda x: np.log(x))
